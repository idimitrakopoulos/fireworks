...
validActions = ['install-clean', 'install-update', 'install-nodb', 'configure', 'backup', 'start', 'stop', 'kill', 'restart', 'status', 'info', 'log', 'debug', 'rollback']
action = None
mandatoryOptions = []
fileOptions = []

def actionUsage():
    print '''Usage: fireworks.py [options]
